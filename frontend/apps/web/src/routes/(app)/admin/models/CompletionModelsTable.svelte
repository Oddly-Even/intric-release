...
<script lang="ts">
  ...
  const viewModel = table.createViewModel([
    table.column({
      ...
      header: $_("app.admin.models.table.columns.name"),
      cell: (item) => {
    ...
    table.column({
      accessor: (model) => model,
      header: $_("app.admin.models.table.columns.enabled"),
      cell: (item) => {
    ...
    table.column({
      accessor: (model) => model,
      header: $_("app.admin.models.table.columns.details"),
      cell: (item) => {
    ...
    table.column({
      accessor: (model) => model,
      header: $_("app.admin.models.table.columns.security"),
      cell: (item) => {
